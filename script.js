let globalDropletManagerInstance; //전역변수 추가하고
...
class EffectCanvas {
    ...
    constructor(width, height, loader) {
        ...
        globalDropletManagerInstance = new DropletManager(this.stage, loader);
    ...
    update(width, height) {
        ...
        globalDropletManagerInstance.update(width, height);
    }
...
class DropletManager {
    constructor(stage, loader) {
        ...
        this.options = {
            ...
            maximumMassGravity: 1000, //Độ nặng - tốc độ rơi của giọt
    ...
    setIntensity(userPercentage) {
        // 추가
        this.options.maximumMassGravity = 20 - (userPercentage / 100) * 20;
        //this.options.dropletGrowSpeed = 0.5 + (userPercentage / 100) * 10;
    }
}

//추가
function setGlobalDropletIntensity(value) {
    if (
        globalDropletManagerInstance &&
        typeof globalDropletManagerInstance.setIntensity === 'function'
    ) {
        globalDropletManagerInstance.setIntensity(value);
    }
}
